 ...
 */
@Wire
public final class WeaponSystem extends EntityProcessingSystem {
    ...
    public WeaponSystem() {
        super(Aspect.all(Weapon.class, Pos.class, Bounds.class, Anim.class));
    }
    ...
    protected void process(Entity gun) {
        ...
        if (bm.has(gun) && !bm.get(gun).built)
            return;
    ...
    private void cycleWeaponPickup(Weapon weapon) {
        ...
        case "rifle":
            ...
            break;
        case "shotgun":
            weapon.bulletAnimId = "grenadelauncher";
            break;
        case "grenadelauncher":
            weapon.bulletAnimId = "flamethrower";
            break;
        case "flamethrower":
            weapon.bulletAnimId = "rifle";
            break;
        }
    }
}

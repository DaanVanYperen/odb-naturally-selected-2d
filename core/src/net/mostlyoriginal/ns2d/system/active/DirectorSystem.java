...
public class DirectorSystem extends VoidEntitySystem {
    ...
    private Stage[] stages = new Stage[] {
            ...
            new Stage(20, 1, 1, 1, 3f, "skulk", "skulk"),
            new Stage(20, STAGE_WARMUP, 1, 1, 1.0f, "babbler", "babbler"),
            new Stage(20, STAGE_WARMUP, 1, 1, 1.0f, "skulk", "skulk"),
            new Stage(20, STAGE_WARMUP, 1, 1, 5.5f, "gorge", "gorge"),
            new Stage(20, STAGE_WARMUP, 1, 1, 0.8f, "skulk", "babbler"),
            new Stage(20, STAGE_WARMUP, 1, 1, 0.7f, "skulk", "gorge"),
            new Stage(20, STAGE_WARMUP, 1, 1, 0.7f, "gorge", "skulk"),
            new Stage(20, STAGE_WARMUP, 2, 2, 0.6f, "babbler", "gorge"),
            ...
            new Stage(20, STAGE_WARMUP, 2, 1, 0.35f, "skulk", "gorge"),
            new Stage(20, STAGE_WARMUP, 2, 1, 0.3f, "skulk", "gorge"),
            new Stage(20, STAGE_WARMUP, 2, 1, 0.3f, "gorge", "gorge"),
            new Stage(20, STAGE_WARMUP, 3, 1, 0.2f, "babbler", "gorge"),

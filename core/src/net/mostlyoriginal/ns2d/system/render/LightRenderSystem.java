...
public final class LightRenderSystem extends EntityProcessingSystem {
    ...
    protected void initialize() {
        ...
        if (!deferredShader.isCompiled())
            throw new RuntimeException("Compilation failed." + deferredShader.getLog());
    }
